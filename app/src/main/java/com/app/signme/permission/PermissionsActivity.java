package com.app.signme.permission;
...
/**
 * Created by Mahesh Lipane on 7/21/2021 on 11:19 AM
 */
...
public class PermissionsActivity extends Activity {
    ...
    private void sendToSettings() {
      ...
      /*  new com.nightlifee.app.permission.AlertDialog(options.settingsDialogTitle,
                options.settingsDialogMessage,
                options.settingsText,
                getString(android.R.string.cancel),
                true,
                new com.nightlifee.app.permission.AlertDialog.ClickListener() {
                    @Override
